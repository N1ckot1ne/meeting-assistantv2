...
import StopIcon from '../../public/stop.png'; // Replace with the correct path to your stop icon

const RecordOnlineMeeting = () => {
      ...
      <div style={{ flex: 1, padding: '20px 40px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
          <img
            ...
            onClick={() => navigate(-1)} // Add your navigation logic here
          />
          <h1 style={{ margin: 0, fontSize: "25px", fontWeight: "900", color: '#034FAF' }}>RECORD ONLINE MEETING</h1>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginTop: '5px' }}>
              ...
              <span style={{ fontSize: '14px', fontWeight: 'bold', marginRight: '15px' }}>07/26/2024 03:09 AM</span>
              <img src={timeIcon} alt="Time Icon" style={{ width: '18px', height: '18px', marginRight: '5px' }} />
              <span style={{ fontSize: '14px', fontWeight: 'bold' }}>00:01:20</span> 
            </div>
          </div>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            ...
            >
              <img src={PlayIcon} alt="Play" style={{ height: '30px' }} /> {/* Replace with the correct path to your play icon */}
            </button>
            <button
              style={{ backgroundColor: 'transparent', border: 'none', cursor: 'pointer', marginRight: '10px' }}
              onClick={handlePauseClick}
            >
              <img src={PauseIcon} alt="Pause" style={{ height: '30px' }} /> {/* Replace with the correct path to your pause icon */}
            </button>
            <button
              style={{ backgroundColor: 'transparent', border: 'none', cursor: 'pointer' }}
              onClick={handleStopClick}
            >
              <img src={StopIcon} alt="Stop" style={{ height: '30px' }} /> {/* Replace with the correct path to your stop icon */}
            </button>
          </div>
        </div>
...
export default RecordOnlineMeeting;
